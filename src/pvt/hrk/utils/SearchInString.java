...
public class SearchInString {
	...
	public enum StringSearchModes {
		...
		STARTSWITH(s -> s.substring(1, s.length()),SearchInString.startsWithIgnoreCase),
		ENDSWITH(s -> s.substring(0, s.length() - 1),SearchInString.endsWithIgnoreCase), 
		CONTAINS(s -> s.substring(1, s.length() - 1),SearchInString.containsIgnoreCase),
		NOTSURE(s -> s,SearchInString.containsIgnoreCase);
